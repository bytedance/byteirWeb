---
title: "关于注意力的Linalg 分块与融合"
date: 2022-06-09
weight: 5
keywords: ["Linalg", "MLIR", "注意力"]
description:
---

注意力机制已经重塑了现代机器学习，但它们的复杂性需要先进的计算策略。我们的 LinalgExt 方言是为补充上游 Linalg 而量身定制的，专门设计用于优化这些机制。通过利用增强的平铺和融合技术，我们的方言提供了一种高效执行基于注意力的模型的流水线型方法。本文档揭示了我们如何应对注意力及其变化带来的挑战。
